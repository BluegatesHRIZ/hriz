...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function tu() {
        let e10 = new TextEncoder().encode(function() {
          let e11 = process.env.JWT_SALT;
          if (!e11) throw Error("JWT_SALT environment variable is not set");
          return e11;
        }());
      ...
      async function tc(e10) {
        try {
          ...
          let [r2, n2, i2] = t2, a2 = `${r2}.${n2}`, o2 = await tu(), s2 = new TextEncoder(), l2 = function(e11) {
      ...
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s([], 85870), e.i(85870), e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"] }, "middleware", () => td], 99446);
      var tp = e.i(99446);
...
var BuildId = "MASTam1n7qZ-ERsXRvWPV";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/adf63_next_dist_esm_build_templates_edge-wrapper_83e2ec22.js", "server/edge/chunks/[root-of-the-server]__089fea41._.js", "server/edge/chunks/fe403_next_dist_esm_build_templates_edge-wrapper_006f3315.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "MASTam1n7qZ-ERsXRvWPV", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "IPUVdSuuzn0Ye211uiuATX6v5YpZWrOmWx8fxGIgTkc=", "__NEXT_PREVIEW_MODE_ID": "4547bd4ec08ac1a28ddbac822756abf7", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "93b8fd319447a1d03b41733311ee64d472993395695971a040676294505d9c52", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "412aa4ead698b3d417fa98ffa37ab325d6221667483c78d02f89975aea389aa8" } } }, "sortedMiddleware": ["/"], "functions": {} };
